...
public class PropertiesInfoUtil {
	...
	private static Class<PropertiesInfoUtil> cls = PropertiesInfoUtil.class;
	...
	public static Properties init(String fileName) {
		try {
			...
			e.printStackTrace();
			LogMessageUtil.e("PropertiesInfoUtil-->>initProperties", "初始化配置文件错误！"  + e.getMessage());
			return null;
		}
	}
	...
	public static String getPropertiesByKey(String key) {
		...
		try {
			...
			e.printStackTrace();
			LogMessageUtil.e("PropertiesInfoUtil-->>getPropertiesByKey", "根据配置文件Key获取Value错误！"  + e.getMessage());
		}
			return value;
	}
	...
	public static Map<String, String> getPropertiesAll(){
		...
		try {
			...
			e.printStackTrace();
			LogMessageUtil.e("PropertiesInfoUtil-->>getPropertiesAll", "读取所有KEY和VALUES"  + e.getMessage());
		}
			return map;
	}
