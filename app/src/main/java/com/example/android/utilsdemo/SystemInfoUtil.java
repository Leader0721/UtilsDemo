...
public class SystemInfoUtil {
	...
	public static String getSysSdk() {
	    ...
	    LogMessageUtil.i("SystemInfoUtil-->>getSysLanguage", sdkVersion);
	    return sdkVersion;
	}
	...
	public static String getSysLanguage() {
		...
		LogMessageUtil.i("SystemInfoUtil-->>getSysLanguage",  language);
		return language;
	}
	...
	public static String getSysModel() {
		...
		LogMessageUtil.i("SystemInfoUtil-->>getSysModel",  model);
		return model;
	}
	...
	public static String getSysRelease() {
		...
		LogMessageUtil.i("SystemInfoUtil-->>getSysRelease",  release);
		return release;
	}
	...
	public static String getSysSIMSerialNum(Context content) {
		...
		LogMessageUtil.i("SystemInfoUtil-->>getSysSIMSerialNum",  simSerialNumber);
    ...
    public static String getSysCPUSerialNum() {
        ...
        try {
            ...
            e.printStackTrace();
            LogMessageUtil.e("SystemInfoUtil-->>getSysCPUSerialNum",  e.getMessage().toString());
        }
        	return cpuSerialNum;
    }
	...
	private static TelephonyManager getSysTelephonyManager(Context content) {
		...
		LogMessageUtil.i("SystemInfoUtil-->>getSysTelephonyManager",  telephonyManager + "");
	...
	public static String getSysTelephoneSerialNum(Context content) {
		...
		LogMessageUtil.i("SystemInfoUtil-->>getSysTelephoneSerialNum",  deviceId + "");
		return deviceId;
	}
	...
	public static String getSysCarrier(Context content) {
		...
		LogMessageUtil.i("SystemInfoUtil-->>getSysCarrier",  moblieType);
		return moblieType;
	}
	...
	public static Integer getSysPhoneState(Context context) {
		...
		LogMessageUtil.i("SystemInfoUtil-->>getSysPhoneState",  callState + "");
		return callState;
	}
	...
	public static CellLocation getSysPhoneLoaction(Context context) {
		...
		LogMessageUtil.i("SystemInfoUtil-->>getSysPhoneLoaction",  cellLocation + "");
		return cellLocation;
	}
	...
	public static String getSysDeviceSoftVersion(Context context) {
		...
		LogMessageUtil.i("SystemInfoUtil-->>getSysDeviceSoftVersion",  deviceSoftwareVersion + "");
	...
	public static String getSysPhoneNumber(Context context) {
		...
		LogMessageUtil.i("SystemInfoUtil-->>getSysPhoneNumber",  phoneNumber + "");
		return phoneNumber;
	}
	...
	public static String getSysSimCode(Context context) {
		...
		LogMessageUtil.i("SystemInfoUtil-->>getSysSimCode",  code + "");
		return code;
	}
	...
	public static String getSysSimPrivatorName(Context context) {
		...
		LogMessageUtil.i("SystemInfoUtil-->>getSysSimPrivatorName",  simOperatorName);
	...
	public static String getSysUserPhoneId(Context context) {
		...
		LogMessageUtil.i("SystemInfoUtil-->>getSysUserPhoneId",  subscriberId);
		return subscriberId;
	}
	...
	public static DisplayMetrics getSysDisplayMetrics(Activity activity) {
		...
		LogMessageUtil.i("SystemInfoUtil-->>getSysDisplayMetrics",  "获取屏幕管理对象为：" + displayMetrics);
	...
	public static int[] getScreenDispaly(Context context) {
		...
		LogMessageUtil.i("SystemInfoUtil-->>getScreenDispaly-->>width",  "获取屏幕宽度为：" + width);
		LogMessageUtil.i("SystemInfoUtil-->>getScreenDispaly-->>height",  "获取屏幕高度为：" + height);
    ...
    public static Integer getSysScreenWidth(Context context) {  
        ...
        LogMessageUtil.i("SystemInfoUtil-->>getSysScreenWidth",  "获取屏幕宽度为：" + displayMetrics.widthPixels);
    ...
    public static Integer getSysScreenHeight(Context context)  {  
        ...
        DisplayMetrics displayMetrics = new DisplayMetrics();  
        wm.getDefaultDisplay().getMetrics(displayMetrics);  
        LogMessageUtil.i("SystemInfoUtil-->>getSysScreenHeight",  "获取屏幕高度为：" + displayMetrics.heightPixels);
    ...
    public static Integer getSysScreenStatusHeight(Context context)  {  
        ...
        try {  
            ...
            LogMessageUtil.i("SystemInfoUtil-->>getSysScreenStatusHeight",  "获取屏幕状态栏高度为：" + statusHeight);
        } catch (Exception e) {  
            e.printStackTrace();  
            LogMessageUtil.e("SystemInfoUtil-->>getSysScreenStatusHeight",  "获取屏幕状态栏高度失败！" + e.getMessage());
        }  
        	return statusHeight;  
    } 
	...
	public static Integer getSysDefaultThreadPoolSize() {
		...
		LogMessageUtil.i("SystemInfoUtil-->>getSysDefaultThreadPoolSize",  availableProcessors + "");
    ...
    public static Integer getSysSampleSize(BitmapFactory.Options options, int minSideLength, int maxNumOfPixels) {  
        ...
        LogMessageUtil.i("SystemInfoUtil-->>getSysSampleSize",  roundedSize + "");
        return roundedSize;  
    }  
    ...
    public String getSysLocalIpAddress() {
        ...
        try {
        	...
        	e.printStackTrace();
        	LogMessageUtil.e("SystemInfoUtil-->>getSysLocalIpAddress",  e.getMessage().toString());
        }
        	LogMessageUtil.i("SystemInfoUtil-->>getSysLocalIpAddress",  hostAddress);
        	return hostAddress;
    }
