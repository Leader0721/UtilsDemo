...
public class CharacterParserUtil {
	...
	private static CharacterParserUtil appcharacterParserUtil = new CharacterParserUtil();
	...
	//单例对象
	public static CharacterParserUtil getAppCharacterParserInstance() {
		return appcharacterParserUtil;
	}
	...
	private int getChsAscii(String chs) {
		...
		try {
			...
			e.printStackTrace();
			LogMessageUtil.e("CharacterParserUtil-->>getChsAscii", e.getMessage().toString());
		}
		return asc;
	}
