...
public class ResourceUtil {
	...
	public static String getStringByAssets(Context context, String fileName) {
		...
		try {
			...
			e.printStackTrace();
			LogMessageUtil.e("ResourceUtil-->>getStringByAssets", "根据本地Assets目录下资源名称，获取String数据信息失败！" + e.getMessage());
			return null;
		}
	}
	...
	public static List<String> getListByAssets(Context context, String fileName) {
		...
		try {
			...
			e.printStackTrace();
			LogMessageUtil.e("ResourceUtil-->>getListByAssets", "根据本地Assets目录下资源名称，获取List集合信息失败！" + e.getMessage());
			return null;
		}
	}
	...
	public static String getStringByRaw(Context context, int resId) {
		...
		try {
			...
			e.printStackTrace();
			LogMessageUtil.e("ResourceUtil-->>getStringByRaw", "根据本地Raw目录下资源标识，获取String数据信息失败！" + e.getMessage());
			return null;
		}
	}
	...
	public static List<String> getListByRaw(Context context, int resId) {
		...
		try {
			...
			e.printStackTrace();
			LogMessageUtil.e("ResourceUtil-->>getListByRaw", "根据本地Raw目录下资源标识，获取List集合信息失败！" + e.getMessage());
			return null;
		}
	}
