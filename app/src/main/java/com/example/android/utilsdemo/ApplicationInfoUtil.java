...
public class ApplicationInfoUtil {
    ...
    public static String getVersionName(Context context) {
        ...
        try {
            ...
            LogMessageUtil.e("ApplicationInfoUtil-->>getVerName()", e.getMessage() + "获取本地Apk版本名称失败！");
            e.printStackTrace();
        }
        return verName;
    }
    ...
    public static int getVersionCode(Context context) {
        ...
        try {
            ...
            LogMessageUtil.e("ApplicationInfoUtil-->>getVerCode()", e.getMessage() + "获取本地Apk版本号失败！");
            e.printStackTrace();
        }
        return verCode;
    }
    ...
    public static String getAppSign(Context context, String packageName) {
        try {
            ...
            throw new RuntimeException(ApplicationInfoUtil.class.getName() + "the " + packageName + "'s application not found");
        }
    }
