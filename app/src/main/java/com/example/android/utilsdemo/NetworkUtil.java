        ...
        if (context != null) {
            ...
            if (mNetworkInfo != null) {
                ...
                if(ConnectivityManager.TYPE_MOBILE == mNetworkInfo.getType()){
                    LogMessageUtil.i("NetworkUtil", "网络连接类型为：TYPE_MOBILE");
                    //判断移动网络连接状态
                    ...
                    if (STATE_MOBILE == State.CONNECTED) {
                        LogMessageUtil.i("AppNetworkMgrd", "网络连接类型为：TYPE_MOBILE, 网络连接状态CONNECTED成功！");
                        return mNetworkInfo.isAvailable();
                    }
                }
                //判断是TYPE_WIFI网络
                if(ConnectivityManager.TYPE_WIFI == mNetworkInfo.getType()){
                    LogMessageUtil.i("NetworkUtil", "网络连接类型为：TYPE_WIFI");
                    //判断WIFI网络状态
                    State STATE_WIFI = mConnectivityManager.getNetworkInfo(ConnectivityManager.TYPE_WIFI).getState();
                    if (STATE_WIFI == State.CONNECTED) {
                        LogMessageUtil.i("NetworkUtil", "网络连接类型为：TYPE_WIFI, 网络连接状态CONNECTED成功！");
                        return mNetworkInfo.isAvailable();
                    }
                }
            }
